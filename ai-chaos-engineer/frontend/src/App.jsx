      ...
      <header className="border-b border-neutral-900 bg-black/80 backdrop-blur-xl z-10 flex-shrink-0">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-2 sm:gap-3 hover:opacity-80 transition-opacity duration-200 focus:outline-none rounded-lg px-2 py-1 -ml-2"
          >
            <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center shadow-lg shadow-blue-500/30">
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <span className="text-xs sm:text-sm font-medium text-neutral-200 hidden sm:inline">Site Reliability Monitor</span>
            <span className="text-xs sm:text-sm font-medium text-neutral-200 sm:hidden">SRM</span>
          </button>
        </div>
      </header>
          ...
          <div className={`w-full space-y-6 sm:space-y-8 ${loading ? 'md:py-8' : 'md:py-4 sm:py-8'}`}>
            ...
            {!loading && (
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-4 sm:pt-6">
                <div className="group relative p-4 sm:p-4 rounded-xl bg-neutral-900/40 border border-neutral-800 hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 hover:-translate-y-1">
                ...
                <div className="group relative p-4 sm:p-4 rounded-xl bg-neutral-900/40 border border-neutral-800 hover:border-pink-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/20 hover:-translate-y-1">
